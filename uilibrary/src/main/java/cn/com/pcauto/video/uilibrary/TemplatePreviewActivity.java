...
import cn.com.pcauto.video.library.VideoComposeCallback;
...
//        }
    ...
    private void goToFjMainActivity(FollowVideoTemplateBean stencilBean) {
        if (stencilBean != null) {
            PCFollowVideoSDK.jumpToFollowVideoMain(mContext, stencilBean, new VideoComposeCallback() {
                @Override
                ...
                @Override
                public void onComposeCompleted(String s) {
                    PCFollowVideoSDK.clearAllFollowVideoPager();
                }
